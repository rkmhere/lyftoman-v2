(function($) {
    ...
    jQuery(window).on('load', function() {
		...
		$('.user-profile-details').attr('id','memberAdminArea');
		
		 $('html, body').animate({
        scrollTop: $("#memberAdminArea").offset().top
    }, 500);
    $(".loader-container").addClass('loader-fadeout');
        // preloader fadeout onload
	//	$('body').scrollToElement(jQuery('#memberAdminArea'));
        /* $(".loader-container").addClass('loader-fadeout');
		  $(".user-sidebar a").each(function() {
		this.href = this.href.split("#")[0] + "#memberAdminArea" ;
			}); */
    });
